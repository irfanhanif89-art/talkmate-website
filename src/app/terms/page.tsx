...
const SECTIONS: Array<{ heading: string; body: string }> = [
  { heading: '1. Introduction', body: 'These Terms of Service govern your use of the TalkMate platform operated by TalkMate Pty Ltd, a company registered in Queensland, Australia. By completing the onboarding process and activating your TalkMate account you agree to be bound by these terms.' },
  { heading: '2. The service', body: 'TalkMate provides AI-powered receptionist services, business communication tools, and related software (the Service). The Service includes the TalkMate Receptionist, TalkMate Command, the TalkMate client portal, and any related features.' },
  { heading: '3. Subscription and payment', body: '3.1 The Service is provided on a monthly or annual subscription basis at the rates displayed at talkmate.com.au/pricing at the time of subscription.\n3.2 Monthly subscriptions are billed monthly in advance. Annual subscriptions are billed once per year, in advance. Payment is processed by Stripe.\n3.3 A one-off setup fee is payable on signup. The setup fee covers AI receptionist configuration, voice tuning, business knowledge setup, and go-live support. Current setup fees are $299 (Starter), $349 (Growth), and $399 (Pro). TalkMate may waive the setup fee at its discretion for certain accounts.\n3.4 You may cancel your subscription at any time from your portal settings. Cancellation takes effect at the end of the current billing period. Setup fees are not refundable except where covered by the money-back guarantee in clause 4.\n3.5 TalkMate reserves the right to change subscription pricing and setup fees with 30 days written notice to existing subscribers.' },
